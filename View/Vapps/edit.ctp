...
<?php echo $this->Form->create('Vapp'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vapp'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>               
            <li><?php echo $this->Html->link(__('View Vapp'), array('action' => 'view', $this->Form->value('Vapp.id'))); ?> </li>
            <li><?php echo $this->Form->postLink(__('Delete Vapp'), array('action' => 'delete', $this->Form->value('Vapp.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vapp.id'))); ?></li>
